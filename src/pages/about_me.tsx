                ...
                <div className="flex items-center mb-8">
                    ...
                    <div>
                        <p className="text-lg mb-6">
                            Hello! I&apos;m Jason Telanoff, a passionate software engineer and a Computer Science and Applied Math double major at UC Berkeley expected to graduate a year and a half early in Fall 2024. I have a strong background in mobile development and efficient algorithms, but enjoy working on a variety of projects.
                        </p>
                        <p className="text-lg mb-6">
